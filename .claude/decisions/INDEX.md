...
- [ADR-0010](ADR-0010-le-gaussien-reste-hors-du-registre.md) [active] — le flou gaussien (et ses dégénérescences box/average) n'entre pas au registre : la référence dit qu'il lave l'image, un flou doux reste atteignable par `lensBlur` à bokeh nul, et le lissage sans perte de contour a son propre effet (`surfaceBlur`)
