...
| ⭐ [`affinity-audit`](../../docs/design-system/affinity-audit-2026-08-19.md) | **LE CHAPEAU, v2** — l'audit full scope par axe, avec niveaux de preuve et chemins d'implémentation ; la v2 du soir ajoute la passe SYSTÉMATIQUE (SDK lu en entier, 22 773 identifiants, inventaire API vivant, ajustements mesurés au pixel) |
| ⭐ [`affinity-code`](../../docs/design-system/affinity-code-2026-08-19.md) | **le code d'Affinity, lu** — JSLib 105 fichiers (BSD-3) en entier par trois agents + scan des kernels (rien de lisible : boîte noire seule voie) : preview transactionnel, commande-valeur, historique-arbre, spline universelle, facettes — mappés sur NOTRE code, et le trou central où NOUS sommes la référence (introspection) |
| ⭐ [`affinity-angles-morts`](../../docs/design-system/affinity-angles-morts-2026-08-19.md) | **ce que les cinq relevés n'avaient pas vu** — Develop RAW cartographié, métadonnées XMP/IPTC/EXIF, scopes vidéo, fusions multi-images, avant/après, points de vue nommés, softproof-calque, macros à échelle, export LUT 3D, MCP serveur |
| [`catalogue-api-sdk.json`](research/catalogue-api-sdk.json) + [`02-ajustements-mesures.md`](research/02-ajustements-mesures.md) + [`serif-affinity-identifiants.txt`](research/serif-affinity-identifiants.txt) | la matière brute de la v2 : inventaire vivant de la surface SDK (60 modules, 384 classes, 200 enums), les courbes MESURÉES de WhiteBalance/Vibrance/SplitToning/ShadowsHighlights/ToneCompression, et les 22 773 identifiants extraits |
