...
| `desktop-commander:terminal` / PowerShell natif | **Défaut pour lancer et monitorer l'app localement** | `scripts/dev.ps1` rend la main après lancement et persiste stdout/stderr; `scripts/monitor.ps1` suit Tauri/Vite et la console WebView2 via CDP. Vérifié en conditions réelles le 2026-07-13. |
