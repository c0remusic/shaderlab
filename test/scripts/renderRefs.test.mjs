...
const ATTENDU = {
  "toile-vide.png": { valeurs: 1 },
  "toile-damier.png": { valeurs: 2 },
  "photo-de-fond-seule.png": { valeurs: null },
  "effets-glow-posterize.png": { valeurs: null },
  "grain-graine-fixe.png": { valeurs: null },
